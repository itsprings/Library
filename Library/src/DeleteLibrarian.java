		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteLibrarian.this,"ID field is blank");
				}else{
					...
					if(i>0){
						...
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Invalid ID");
					}
				}
			}
		});
